//! Yoinked from the unstable (at the time of writing) version of the standard library:
//!     https://ziglang.org/documentation/master/std/#src/std/deque.zig
...
pub fn Deque(comptime T: type) type {
    return struct {
        ...
        /// Yanked from the ArrayList, because it is not marked `pub`, but it was needed here
